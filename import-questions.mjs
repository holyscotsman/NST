...
writeFileSync(new URL("./questions.js", import.meta.url), banner + "window.STARNIX_QUESTIONS = " + JSON.stringify(pack, null, 2) + ";\n");
...
writeFileSync(new URL("./questions.side-report.json", import.meta.url), JSON.stringify(report, null, 2));
