...
export class Studio {
  ...
  _buildStudio() {
    ...
    // (TX) gold accent ring around the existing center medallion (the neon-emblem
    // `medallion` group built in the set-detail section below owns the inlay itself).
    const medRing = new THREE.Mesh(new THREE.TorusGeometry(1.9, 0.05, 10, 64), mat(0x000000, PAL.gold, 1.5));
