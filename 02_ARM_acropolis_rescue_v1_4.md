...
<!-- doc-version: v1.4 · baseline v1.0 = original file · MINOR (question-timeout damage canon per Jason's ruling; no contract change) -->
**Doc version:** v1.4 · **Owner:** single chat (was ARM) · **Edited:** 2026-07-03
**Change vs v1.3:** the death-by-timeout section now describes REAL canon (v0.65.0, Jason's ruling): field core-scan timeouts damage shields. No contract or question-bank change.
