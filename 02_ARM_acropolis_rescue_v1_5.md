...
<!-- doc-version: v1.5 · baseline v1.0 = original file · MINOR (difficulty-shape toggle shipped; tier cliffs smoothed) -->
**Doc version:** v1.5 · **Owner:** single chat · **Edited:** 2026-07-11
...
- [ ] New puzzle types · minimap · codex · ~~difficulty-shape toggle~~ (shipped `v0.155.0` — "Smooth difficulty", see header)
